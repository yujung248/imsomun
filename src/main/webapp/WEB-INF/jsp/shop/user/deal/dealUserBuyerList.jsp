...
<body>
	...
	<script type="text/javascript">
		...
		function fn_egov_select_dealList(pageNo) {
			...
			document.frm.action = "<c:url value='/shop/user/deal/dealUserBuyerList.do'/>";
			document.frm.submit();
		}
		function searchChd(){
			document.frm.pageIndex.value = 1;
			document.frm.action="/shop/user/deal/dealUserBuyerList.do";
			document.frm.submit();
		}
		...
		function productChange(p_idx){
			 if(confirm(" 거래 취소된 항목입니다. \n 해당 상품 상세 페이지로 이동 하시려면 예를 누르시고\n 취소 하시려면 아니오를 눌러주세요")){
				 ...
				 document.frm.action="/shop/user/product/EgovBuyerProductForm.do";
				 document.frm.submit();
			 }
			 else{
			 alert('아니오를 누르셨습니다');
			...
			<div class="row">
				<div class="col-md-4">
					<div class="input-group mb-3">
						<input type="text" class="form-control" placeholder="상품이름, 판매자"
